package org.example.homework.modul1.lesson7_8;

import org.example.homework.modul1.lesson7_8.ex1.Auto;
import org.example.homework.modul1.lesson7_8.ex1.AutoWash;
import org.example.homework.modul1.lesson7_8.ex1.Bus;
import org.example.homework.modul1.lesson7_8.ex1.Car;
import org.example.homework.modul1.lesson7_8.ex2.Airplane;
import org.example.homework.modul1.lesson7_8.ex2.Duck;
import org.example.homework.modul1.lesson7_8.ex2.Fly;
import org.example.homework.modul1.lesson7_8.ex2.FlyException;
import org.example.homework.modul1.lesson7_8.ex3.*;
...
public class HomeWork4 {
    ...
    public static void ex1() {
        ...
        for (int i = 0; i < 4; i++) {
            autos[i] = new Car(false, 1.8, 2, 5, true);
        }
        for (int i = 4; i < 9; i++) {
            autos[i] = new Bus(false, 2.3, 3, 12, 20);
        }
        int totalPrice = 0;
        for (Auto auto : autos) {
            totalPrice += AutoWash.washCar(auto);
        }
        System.out.println("Мэрия заплатит за мойку машин: " + totalPrice + "₽");
    ...
    public static void ex3() {
        ...
        Bird bird = new Bird();
        Sound[] beings = {human, builder, driver, bird};

        for (Sound being : beings) {
