package org.example.homework.modul1.lesson3_4;
...
public class HomeWork2 {
        ...
        public static void ex2() {
            ...
            int endNumberIndex = numbers.length - 1;

            while (endNumberIndex > startNumberIndex) {
                int temp = numbers[startNumberIndex];
                numbers[startNumberIndex] = numbers[endNumberIndex];
                numbers[endNumberIndex] = temp;
                startNumberIndex++;
                endNumberIndex--;
            }
        ...
        public static void ex3() {
            ...
            while (true) {
                ...
                tryNumbers++;
                if (number == 999) {
                    System.out.println("Совершено количeство попыток для получения числа 999: " + tryNumbers);
                    break;
                }
            }
